...
class SourceController extends Controller
{
    ...
    {
        $soursesList = $sourcesQueryBuilder->getAll();
        return \view('admin.sources.index', [
            'sourcesList' => $soursesList,
        ]);
    }
    ...
    public function store(CreateRequest $request): RedirectResponse
    {
        ...
        return \back()
            ->with('error', __('messages.admin.sources.fail'));
    }
    ...
    public function update(EditRequest $request, Source $source): RedirectResponse
    {
        ...
        if($source->save()){
            return \redirect()
                ->route('admin.sources.index')
                ->with('success', __('messages.admin.sources.updateSuccess'));
        }
        return \back()
            ->with('error', __('messages.admin.sources.fail'));
    }
